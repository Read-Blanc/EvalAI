...
def create_user(
    ...
    password: str,
    full_name: str,
    role: Union[str, UserRole],  # ✅ Can accept both
    ...
    # ✅ CRITICAL FIX: Always pass the string VALUE, not the enum
    if isinstance(role, UserRole):
        # If it's already an enum, get its value
        role_value = role.value  # Gets "lecturer", not "LECTURER"
    ...
    db_user = User(
        ...
        full_name=full_name,
        role=role_value,  # ✅ Pass enum object
